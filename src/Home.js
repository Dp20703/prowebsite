            ...
            <Row>
                ...
                <Col>
                    <Card style={{ width: '25rem' }} className="h-100"  >
                        <Card.Img src='https://plus.unsplash.com/premium_photo-1663134377392-50c34664d632?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8c3RhZmZ8ZW58MHx8MHx8fDA%3D' style={{ height: '350px' }} />
                        <Card.Body>
                ...
                <Col>
                    <Card style={{ width: '25rem' }} className="h-100" >
                        <Card.Img src='https://images.unsplash.com/photo-1568658176307-bfbd2873abda?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8c3RhZmZ8ZW58MHx8MHx8fDA%3D' style={{ height: '350px' }} />
                        <Card.Body>
                            <Card.Title>Consulting</Card.Title>
                            <Card.Text>
...
function Map(){
    return(
        <>
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14686.427948409413!2d72.5583797!3d23.0381982!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e85ff3a38c353%3A0xdabe316634ef7e5e!2sInfoLabz!5e0!3m2!1sen!2sin!4v1728456633093!5m2!1sen!2sin" width="600" height="450" style={{border:"0"}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </>
    );
}